...
// 2020-12-15 20:02:05.415169 +0100 CET m=+0.018215046
...
func (s *Uint16) AppendSample(value uint64) {
...
func (s *Uint16) Free(p *PoolAllocator) {
...
func (s *Uint16) Append(src Unsigned) {
...
func (s *Uint16) Channel(c int) Unsigned {
