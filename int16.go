...
// 2020-12-16 20:52:36.099155 +0100 CET m=+0.018930668
...
// i16 is int16 Signed fixed-point signal.
type i16 struct {
	buffer []int16
	channels
	bitDepth
...
// Int16 selects a new sequential int16 signal buffer.
// from the pool.
...
func (s *i16) AppendSample(value int64) {
...
// Sample values are capped by maximum value of the buffer bit depth.
func (s i16) SetSample(i int, value int64) {
	s.buffer[i] = int16(s.BitDepth().SignedValue(value))
}

// Puti16 places signal buffer back to the pool. If a type of
// provided buffer isn't i16 or its capacity doesn't equal
// allocator capacity, the function will panic.
func (s *i16) Free(p *PoolAllocator) {
...
func (s *i16) Slice(start, end int) Signed {
...
func (s *i16) Channel(c int) Signed {
