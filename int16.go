...
// 2020-09-11 21:34:57.814489 +0200 CEST m=+0.018728678
...
// from the pool.
func (p *Pool) GetInt16(length int, bd BitDepth) Signed {
	if p == nil {
		return nil
	}
	return Int16{
		buffer:   p.i16.Get().([]int16)[:p.channels*length],
