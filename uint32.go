...
// 2020-12-16 20:52:36.095637 +0100 CET m=+0.015412546
...
// u32 is uint32 Unsigned fixed-point signal.
type u32 struct {
	buffer []uint32
	channels
	bitDepth
...
// Uint32 selects a new sequential uint32 signal buffer.
// from the pool.
...
func (s *u32) AppendSample(value uint64) {
...
// Sample values are capped by maximum value of the buffer bit depth.
func (s u32) SetSample(i int, value uint64) {
	s.buffer[i] = uint32(s.BitDepth().UnsignedValue(value))
}

// Putu32 places signal buffer back to the pool. If a type of
// provided buffer isn't u32 or its capacity doesn't equal
// allocator capacity, the function will panic.
func (s *u32) Free(p *PoolAllocator) {
...
func (s *u32) Sample(i int) uint64 {
...
func (s *u32) Append(src Unsigned) {
...
func (s *u32) Slice(start, end int) Unsigned {
...
func (s *u32) Channel(c int) Unsigned {
