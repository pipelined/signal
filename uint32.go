...
// 2020-09-12 15:44:22.495124 +0200 CEST m=+0.009014408
...
func (p PoolAllocator) GetUint32(bd BitDepth) Unsigned {
	return Uint32{
		buffer:   p.u32.Get().([]uint32)[:p.Channels*p.Length],
...
func (p PoolAllocator) PutUint32(s Unsigned) {
