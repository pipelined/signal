...
// 2020-09-12 15:44:22.498379 +0200 CEST m=+0.012269560
...
func (p PoolAllocator) GetFloat64() Floating {
	return Float64{
		buffer:   p.f64.Get().([]float64)[:p.Channels*p.Length],
...
func (p PoolAllocator) PutFloat64(s Floating) {
