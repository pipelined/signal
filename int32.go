...
// 2020-09-12 15:44:22.501431 +0200 CEST m=+0.015322219
...
func (p PoolAllocator) GetInt32(bd BitDepth) Signed {
	return Int32{
		buffer:   p.i32.Get().([]int32)[:p.Channels*p.Length],
...
func (p PoolAllocator) PutInt32(s Signed) {
