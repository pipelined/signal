...
// 2020-09-11 21:34:57.806412 +0200 CEST m=+0.010651612
...
// from the pool.
func (p *Pool) GetUint64(length int, bd BitDepth) Unsigned {
	if p == nil {
		return nil
	}
	return Uint64{
		buffer:   p.u64.Get().([]uint64)[:p.channels*length],
