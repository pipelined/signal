...
// 2020-12-16 20:52:36.087561 +0100 CET m=+0.007337132
...
// u64 is uint64 Unsigned fixed-point signal.
type u64 struct {
	buffer []uint64
	channels
	bitDepth
...
// Uint64 selects a new sequential uint64 signal buffer.
// from the pool.
...
func (s *u64) AppendSample(value uint64) {
...
// Sample values are capped by maximum value of the buffer bit depth.
func (s u64) SetSample(i int, value uint64) {
	s.buffer[i] = uint64(s.BitDepth().UnsignedValue(value))
}

// Putu64 places signal buffer back to the pool. If a type of
// provided buffer isn't u64 or its capacity doesn't equal
// allocator capacity, the function will panic.
func (s *u64) Free(p *PoolAllocator) {
...
func (s *u64) Sample(i int) uint64 {
...
func (s *u64) Append(src Unsigned) {
...
func (s *u64) Slice(start, end int) Unsigned {
...
func (s *u64) Channel(c int) Unsigned {
